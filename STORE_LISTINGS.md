# Chrome Web Store Listings - All Languages

This document contains all the localized content for the Chrome Web Store listing in all supported languages.
...
The fastest and easiest way to inspect, copy and analyze CSS styles on any webpage with syntax highlighting and live editing.
...
### Short Description (132 characters max)
Le moyen le plus rapide et facile d'inspecter, copier et analyser les styles CSS sur n'importe quelle page web.
...
- Scanner l'Element Parent : Ctrl+Shift+E (Windows/Linux) ou Cmd+Shift+E (Mac)
- Changer d'onglet : 1 (CSS), 2 (HTML), 3 (Source), 4 (Editeur)
- Naviguer entre freres : Fleche Gauche / Fleche Droite
- Copie rapide : Ctrl+C / Cmd+C
- Parcourir les sections : Tab / Shift+Tab
...
- Les etudiants apprenant le developpement web
...
3. Consultez le CSS dans le panneau d'inspection
4. Cliquez sur "Copier" pour copier les styles
...
- Options de copie (CSS uniquement, HTML uniquement, les deux)
- Preferences de superposition de grille
- Theme clair ou sombre pour l'inspecteur
- Selection de la langue
- Et plus encore...

Cree par Simon Adjatan | Licence MIT | Open Source
...
### Short Description (132 characters max)
La forma mas rapida y facil de inspeccionar, copiar y analizar estilos CSS en cualquier pagina web.
...
- Escanear Elemento Padre: Ctrl+Shift+E (Windows/Linux) o Cmd+Shift+E (Mac)
- Cambiar pestaña: 1 (CSS), 2 (HTML), 3 (Fuente), 4 (Editor)
- Navegar hermanos: Flecha Izquierda / Flecha Derecha
- Copia rápida: Ctrl+C / Cmd+C
- Recorrer secciones: Tab / Shift+Tab
...
3. Ve el CSS en el panel del inspector
4. Haz clic en "Copiar" para copiar los estilos
...
- Opciones de copia (solo CSS, solo HTML, ambos)
- Preferencias de superposicion de cuadricula
- Tema claro u oscuro para el inspector
- Seleccion de idioma
- Y mas...

Creado por Simon Adjatan | Licencia MIT | Codigo Abierto
...
### Short Description (132 characters max)
Die schnellste und einfachste Moeglichkeit, CSS-Stile auf jeder Webseite zu inspizieren, zu kopieren und zu analysieren.
...
- Eltern-Element Scannen: Strg+Umschalt+E (Windows/Linux) oder Cmd+Shift+E (Mac)
- Tab wechseln: 1 (CSS), 2 (HTML), 3 (Quelle), 4 (Editor)
- Geschwister navigieren: Pfeil Links / Pfeil Rechts
- Schnelles Kopieren: Ctrl+C / Cmd+C
- Abschnitte durchlaufen: Tab / Shift+Tab
...
- Studenten, die Webentwicklung lernen
...
3. Sehen Sie CSS im Inspektor-Panel
4. Klicken Sie auf "Kopieren", um Stile zu kopieren
...
- Kopieroptionen (nur CSS, nur HTML, beides)
- Rasterueberlagerungspraeferenzen
- Helles oder dunkles Inspektor-Design
- Sprachauswahl
- Und mehr...

Erstellt von Simon Adjatan | MIT-Lizenz | Open Source
...
### Short Description (132 characters max)
A maneira mais rapida e facil de inspecionar, copiar e analisar estilos CSS em qualquer pagina web.
...
- Escanear Elemento Pai: Ctrl+Shift+E (Windows/Linux) ou Cmd+Shift+E (Mac)
- Trocar aba: 1 (CSS), 2 (HTML), 3 (Fonte), 4 (Editor)
- Navegar irmãos: Seta Esquerda / Seta Direita
- Cópia rápida: Ctrl+C / Cmd+C
- Percorrer seções: Tab / Shift+Tab
...
- Estudantes aprendendo desenvolvimento web
...
3. Veja o CSS no painel do inspetor
4. Clique em "Copiar" para copiar os estilos
...
- Opcoes de copia (somente CSS, somente HTML, ambos)
- Preferencias de sobreposicao de grade
- Tema claro ou escuro para o inspetor
- Selecao de idioma
- E mais...

Criado por Simon Adjatan | Licenca MIT | Codigo Aberto
...
### Short Description (132 characters max)
あらゆるウェブページのCSSスタイルを最速で簡単に検査、コピー、分析できるツール。シンタックスハイライトとライブ編集機能付き。
...
- 親要素をスキャン: Ctrl+Shift+E (Windows/Linux) または Cmd+Shift+E (Mac)
- タブ切替: 1 (CSS), 2 (HTML), 3 (ソース), 4 (エディター)
- 兄弟要素間移動: 左矢印 / 右矢印
- クイックコピー: Ctrl+C / Cmd+C
- セクション巡回: Tab / Shift+Tab
- フリーズ/解除: Space
- スキャナーを閉じる: Esc
...
- 子要素の包含/除外
- コピーオプション（CSSのみ、HTMLのみ、両方）
- グリッドオーバーレイの設定
- ライトまたはダークのインスペクターテーマ
- 言語選択
- その他...

作者: Simon Adjatan | MITライセンス | オープンソース

---

## Store Listing Assets Required

For each language, you should also provide:

### Screenshots
- 5 screenshots (1280x800 or 640x400 recommended)
- Add text overlays in the target language highlighting features
...
### Privacy Policy
See CHROME_WEB_STORE_SUBMISSION.md (translate if needed)

---

## How to Submit Localized Listings

1. Go to Chrome Web Store Developer Dashboard
2. Navigate to your extension's listing
3. Click "Store Listing" tab
4. At the top, you'll see "Add a new language"
5. Select each language (fr, es, de, pt, ja) and paste the content above
6. Save each language listing
7. Submit for review

The Chrome Web Store will automatically show the appropriate language based on the user's browser settings.
